...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .brand-logo { display: block; width: auto; max-width: 320px; max-height: 52px; object-fit: contain; }
