...
${iconLinkHtml}
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .template-hero-image-led .site-header { position: absolute; top: 0; left: 0; right: 0; z-index: 10000; background: linear-gradient(180deg, rgba(5, 18, 32, 0.48), rgba(5, 18, 32, 0.24)); border-bottom: 1px solid rgba(255, 255, 255, 0.08); box-shadow: none; backdrop-filter: blur(6px); -webkit-backdrop-filter: blur(6px); pointer-events: auto; }
