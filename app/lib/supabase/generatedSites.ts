...
${iconLinkHtml}
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    html[data-cb-preview-viewport="mobile"], html[data-cb-preview-viewport="tablet"] { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; width: 100%; max-width: 100%; overflow-x: hidden; }
    html[data-cb-preview-viewport="mobile"] body, html[data-cb-preview-viewport="tablet"] body { width: 100%; max-width: 100%; overflow-x: hidden; }
    ...
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .hero { background-position: center center !important; }
    ...
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .hero::before, html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .hero::after { background-position: center center !important; }
