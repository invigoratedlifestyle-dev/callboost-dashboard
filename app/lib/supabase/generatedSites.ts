...
${iconLinkHtml}
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    @media (min-width: 981px) { .template-hero-image-led .hero { min-height: clamp(760px, 88vh, 960px); aspect-ratio: auto; background-position: center top; background-size: cover; background-repeat: no-repeat; } }
