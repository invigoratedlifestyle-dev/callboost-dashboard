...
${iconLinkHtml}
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    a { color: inherit; }
    h1, h2, h3, p { margin: 0; }
    h1 { max-width: 820px; margin: 0 auto; color: white; font-size: clamp(48px, 6.8vw, 88px); font-weight: 800; line-height: 0.94; letter-spacing: -0.048em; text-wrap: balance; }
    ...
    .hero-label { margin-bottom: 12px; color: var(--hero-accent-color); font-size: 13px; font-weight: 950; letter-spacing: 0.18em; text-transform: uppercase; }
    .hero-subtitle { max-width: 660px; margin: 18px auto 0; color: rgba(241, 245, 249, 0.9); font-size: 19px; line-height: 1.55; }
    ...
    .button { min-height: 54px; display: inline-flex; align-items: center; justify-content: center; padding: 14px 22px; border-radius: 11px; border: 1px solid transparent; font-size: 16px; font-weight: 950; letter-spacing: -0.01em; text-decoration: none; cursor: pointer; }
    .button.accent { background: var(--cta-color); color: var(--cta-text-color); box-shadow: 0 18px 36px rgba(20, 184, 166, 0.28); }
    ...
    .template-hero-image-led .site-header { position: absolute; left: 0; right: 0; background: rgba(2, 6, 23, 0.04); border-bottom: 0; box-shadow: none; backdrop-filter: blur(8px); }
    ...
    .template-hero-image-led .hero { min-height: clamp(700px, 92vh, 960px); align-items: flex-end; padding: 160px 0 72px; background: linear-gradient(180deg, rgba(2, 6, 23, 0.22) 0%, rgba(2, 6, 23, 0.02) 46%, rgba(2, 6, 23, 0.28) 100%), var(--hero-img); background-position: center; background-size: cover; }
    .template-hero-image-led .visual-hero-content { max-width: 1120px; display: flex; justify-content: flex-end; text-align: left; }
    .template-hero-image-led .visual-hero-cta { margin: 0; justify-content: flex-end; }
    .template-hero-image-led .hero .button.accent { min-height: 60px; padding: 15px 24px; border: 1px solid rgba(94, 234, 212, 0.34); border-radius: 18px; background: linear-gradient(135deg, rgba(2, 6, 23, 0.62), rgba(15, 118, 110, 0.42)); color: #ffffff; box-shadow: 0 22px 50px rgba(2, 6, 23, 0.34), 0 0 34px rgba(20, 184, 166, 0.22); backdrop-filter: blur(18px); }
    ...
    @media (max-width: 700px) { body { padding-bottom: 82px; } .container { width: min(100% - 28px, 1120px); } .nav { min-height: 88px; gap: 12px; } .brand.has-logo { min-width: 0; max-width: 100%; } .brand strong { max-width: 230px; font-size: 16px; line-height: 1.2; } .brand span { font-size: 12px; } .brand-logo { width: auto; height: auto; max-width: min(340px, 100%); max-height: 58px; object-fit: contain; } .nav-call { display: none; } .hero { min-height: auto; padding: 58px 0 86px; background-image: linear-gradient(rgba(0, 0, 0, 0.55), rgba(0, 0, 0, 0.55)), var(--hero-img-mobile); } .template-hero-image-led .site-header { position: absolute; top: 0; left: 0; right: 0; z-index: 60; background: transparent; border: 0; box-shadow: none; backdrop-filter: none; pointer-events: none; } .template-hero-image-led .nav { min-height: 0; width: 100%; display: block; padding: 0; } .template-hero-image-led .brand, .template-hero-image-led .brand.has-logo, .template-hero-image-led .nav-links { display: none; } .template-hero-image-led .nav-call { position: absolute; top: calc(16px + env(safe-area-inset-top)); right: 18px; min-height: 42px; max-width: min(46vw, 168px); display: inline-flex; padding: 9px 13px; border: 1px solid rgba(255, 255, 255, 0.22); border-radius: 999px; background: rgba(2, 6, 23, 0.42); color: #ffffff; box-shadow: 0 14px 30px rgba(2, 6, 23, 0.26); backdrop-filter: blur(16px); font-size: 12px; overflow: hidden; text-overflow: ellipsis; pointer-events: auto; } .template-hero-image-led .hero { min-height: clamp(500px, 76vh, 680px); padding: 0 0 26px; align-items: flex-end; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.06) 0%, rgba(2, 6, 23, 0.01) 48%, rgba(2, 6, 23, 0.12) 72%, rgba(2, 6, 23, 0.34) 100%), var(--hero-img-mobile); background-position: center top; background-size: cover; } .template-hero-image-led .visual-hero-content { justify-content: center; } .template-hero-image-led .visual-hero-cta { width: 100%; justify-content: center; } .template-hero-image-led .hero .button.accent { width: min(86%, 290px); min-height: 52px; padding: 13px 18px; border-radius: 16px; font-size: 15px; box-shadow: 0 16px 34px rgba(2, 6, 23, 0.3), 0 0 24px rgba(20, 184, 166, 0.18); } h1 { max-width: 100%; font-size: clamp(38px, 12vw, 54px); line-height: 0.98; letter-spacing: -0.04em; overflow-wrap: anywhere; } .hero-subtitle { max-width: 34rem; font-size: 17px; line-height: 1.5; } .hero-label { margin-bottom: 10px; font-size: 12px; letter-spacing: 0.16em; } .hero-bullets { display: grid; grid-template-columns: 1fr 1fr; } .hero-bullets span { border-radius: 12px; } .button, .cta-row, .cta-row a { width: 100%; } .quote-strip { margin-top: -44px; } .template-hero-image-led .quote-strip { margin-top: 0; padding-top: 24px; } .quote-card, .contact-panel, .callback-form, .areas-panel { padding: 22px; } .mini-form, .services-grid, .trust-grid, .review-grid, .faq-grid, .footer-grid { grid-template-columns: 1fr; } .section { padding: 58px 0; } .footer { padding-bottom: 32px; } .footer-bottom { display: grid; } .mobile-call-bar { display: block; position: fixed; left: 12px; right: 12px; bottom: 12px; z-index: 80; } .mobile-call-bar a { min-height: 58px; display: flex; align-items: center; justify-content: center; border-radius: 12px; background: var(--cta-color); color: var(--cta-text-color); box-shadow: 0 18px 38px rgba(2, 6, 23, 0.24); font-size: 17px; font-weight: 950; text-decoration: none; } }
  </style>
</head>
