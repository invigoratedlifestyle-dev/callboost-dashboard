...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .brand { min-width: 0; display: flex; flex-direction: column; justify-content: center; color: #111827; text-decoration: none; }
    ...
    .brand-logo { display: block; width: auto; max-width: 420px; max-height: 64px; object-fit: contain; }
