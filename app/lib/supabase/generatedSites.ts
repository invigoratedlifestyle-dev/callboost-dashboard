...
${iconLinkHtml}
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    @media (min-width: 981px) { .template-hero-image-led .hero { min-height: clamp(640px, 76vh, 820px); aspect-ratio: auto; background-position: center top; background-size: 100% auto; } }
