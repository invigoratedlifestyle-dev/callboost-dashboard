...
${iconLinkHtml}
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    @media (min-width: 981px) { .template-hero-image-led .hero { min-height: clamp(640px, 78vh, 860px); aspect-ratio: auto; background-position: center 48%; background-size: cover; } }
