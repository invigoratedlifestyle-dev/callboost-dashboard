...
${iconLinkHtml}
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .hero, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .hero { min-height: clamp(560px, 82vh, 720px); padding: 0; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile); background-position: center top; background-size: cover; }
