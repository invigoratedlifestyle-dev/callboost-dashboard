...
${iconLinkHtml}
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    @media (min-width: 981px) { .template-hero-image-led .hero { min-height: min(100vh, calc(100vw * 1086 / 1448)); aspect-ratio: 1448 / 1086; } }
    ...
    html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .hero { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; aspect-ratio: 1080 / 1200; }
