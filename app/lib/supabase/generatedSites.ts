...
${iconLinkHtml}
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .template-hero-image-led .site-header { position: absolute; left: 0; right: 0; z-index: 80; background: rgba(2, 6, 23, 0.12); border-bottom: 0; box-shadow: none; backdrop-filter: blur(3px); pointer-events: auto; }
    .template-hero-image-led .nav, .template-hero-image-led .nav-links, .template-hero-image-led .nav-links a, .template-hero-image-led .nav-call { position: relative; z-index: 81; pointer-events: auto; }
    ...
    .template-hero-image-led .hero { position: relative; z-index: 0; min-height: clamp(720px, 92vh, 980px); align-items: stretch; padding: 0; background: linear-gradient(180deg, rgba(2, 6, 23, 0.26) 0%, rgba(2, 6, 23, 0.04) 22%, rgba(2, 6, 23, 0.02) 100%), var(--hero-img); background-position: center; background-size: cover; }
    ...
    @media (min-width: 981px) { .template-hero-image-led .hero { min-height: min(100vh, calc(100vw / 1.78)); aspect-ratio: 1.78 / 1; } }
    ...
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .hero, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .hero { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; min-height: auto; aspect-ratio: 1080 / 1350; padding: 0; background: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-color: #07111f; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-position: center top !important; background-repeat: no-repeat !important; background-size: 100% auto !important; }
    html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .hero { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; aspect-ratio: 1080 / 1350; }
