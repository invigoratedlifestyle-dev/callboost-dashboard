...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .brand-logo { display: block; width: auto; max-width: 220px; max-height: 40px; object-fit: contain; }
