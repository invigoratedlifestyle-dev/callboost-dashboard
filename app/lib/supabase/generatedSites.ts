...
${iconLinkHtml}
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .template-hero-image-led .nav, .template-hero-image-led .nav-links, .template-hero-image-led .nav-links a, .template-hero-image-led .nav-call { position: relative; z-index: 1001; pointer-events: auto; }
    ...
    @media (min-width: 981px) { .template-hero-image-led .hero { min-height: clamp(620px, 72vh, 760px); aspect-ratio: auto; background-position: center top; background-size: auto 100%; background-repeat: no-repeat; } }
