...
${iconLinkHtml}
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .hero-label { margin-bottom: 14px; color: var(--hero-accent-color); font-size: 14px; font-weight: 950; letter-spacing: 0.13em; text-transform: uppercase; }
