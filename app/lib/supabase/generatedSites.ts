...
${iconLinkHtml}
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .nav, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .nav { min-height: 50px; width: 100%; display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 7px 8px; }
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .brand, html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .brand.has-logo, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand.has-logo { min-width: 0; max-width: calc(100% - 126px); display: flex; flex: 1 1 auto; align-items: center; overflow: hidden; }
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .brand-logo, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand-logo { width: auto; height: auto; max-width: min(172px, 100%); max-height: 32px; object-fit: contain; }
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .brand strong, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand strong { max-width: 100%; font-size: 12px; line-height: 1.08; white-space: normal; overflow-wrap: anywhere; }
    ...
    html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .nav { min-height: 58px; gap: 12px; padding: 8px 10px; }
    html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand.has-logo { max-width: calc(100% - 152px); }
    html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand-logo { max-width: min(230px, 100%); max-height: 40px; }
    html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand strong { font-size: 14px; }
    html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .nav-call { min-height: 40px; max-width: min(34vw, 168px); padding: 8px 12px; font-size: 12px; }
    ...
    @media (max-width: 700px) { .template-hero-image-led .site-header { top: calc(10px + env(safe-area-inset-top)); left: 10px; right: 10px; border-radius: 16px; } .template-hero-image-led .nav { min-height: 50px; gap: 8px; padding: 7px 8px; } .template-hero-image-led .brand, .template-hero-image-led .brand.has-logo { max-width: calc(100% - 126px); } .template-hero-image-led .brand-logo { max-width: min(172px, 100%); max-height: 32px; } .template-hero-image-led .brand strong { font-size: 12px; } .template-hero-image-led .nav-call { min-height: 36px; max-width: min(42vw, 134px); padding: 8px 10px; font-size: 11px; } .template-hero-image-led .hero { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; min-height: clamp(620px, 88vh, 780px); aspect-ratio: auto; padding: 0; background: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-color: #07111f; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-position: center center !important; background-repeat: no-repeat !important; background-size: cover !important; } .template-hero-image-led .hero::before, .template-hero-image-led .hero::after { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; background: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-color: #07111f; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-position: center center !important; background-repeat: no-repeat !important; background-size: cover !important; } .template-hero-image-led .quote-strip { margin-top: 0; } }
    @media (min-width: 701px) and (max-width: 980px) { .template-hero-image-led .site-header { top: calc(14px + env(safe-area-inset-top)); left: 16px; right: 16px; border-radius: 18px; } .template-hero-image-led .nav { min-height: 58px; gap: 12px; padding: 8px 10px; } .template-hero-image-led .brand, .template-hero-image-led .brand.has-logo { max-width: calc(100% - 152px); } .template-hero-image-led .brand-logo { max-width: min(230px, 100%); max-height: 40px; } .template-hero-image-led .brand strong { font-size: 14px; } .template-hero-image-led .nav-call { min-height: 40px; max-width: min(34vw, 168px); padding: 8px 12px; font-size: 12px; } .template-hero-image-led .hero { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; min-height: clamp(700px, 90vh, 900px); aspect-ratio: auto; padding: 0; background: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-color: #07111f; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-position: center center !important; background-repeat: no-repeat !important; background-size: cover !important; } .template-hero-image-led .hero::before, .template-hero-image-led .hero::after { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; background: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-color: #07111f; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-position: center center !important; background-repeat: no-repeat !important; background-size: cover !important; } .template-hero-image-led .quote-strip { margin-top: 0; } }
  </style>
</head>
