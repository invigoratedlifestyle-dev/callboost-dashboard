...
${iconLinkHtml}
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    @media (min-width: 981px) { .template-hero-image-led .hero { min-height: clamp(620px, 72vh, 760px); aspect-ratio: auto; background-position: center top; background-size: cover; background-repeat: no-repeat; } }
