...
${iconLinkHtml}
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .template-hero-image-led .site-header { position: absolute; top: 0; left: 0; right: 0; z-index: 10000; background: linear-gradient(180deg, rgba(5, 18, 32, 0.72), rgba(5, 18, 32, 0.42)); border-bottom: 1px solid rgba(255, 255, 255, 0.08); box-shadow: none; backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); pointer-events: auto; }
    ...
    @media (max-width: 980px) { .nav { min-height: 110px; display: flex; justify-content: space-between; } .brand.has-logo { min-width: 0; max-width: min(620px, calc(100% - 190px)); } .brand-logo { max-width: min(620px, 100%); max-height: 82px; } .nav-links { display: none; } .template-hero-image-led .visual-hero-content { justify-content: flex-start; } .template-hero-image-led .visual-hero-cta { justify-content: flex-start; } .template-hero-image-led .hero { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; aspect-ratio: auto; background: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-size: cover !important; } .quote-card, .areas-panel, .contact-layout { grid-template-columns: 1fr; } .services-grid, .trust-grid, .review-grid, .faq-grid, .footer-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); } }
