...
${iconLinkHtml}
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .template-hero-image-led .hero::before, .template-hero-image-led .hero::after { z-index: 0; pointer-events: none; }
    .template-hero-image-led .hero .container { position: relative; z-index: 0; pointer-events: none; }
    ...
    @media (min-width: 981px) { .template-hero-image-led .site-header .nav.container { width: min(100% - 40px, 1440px); } .template-hero-image-led .hero { min-height: clamp(780px, 90vh, 980px); aspect-ratio: auto; background-position: center top; background-size: cover; background-repeat: no-repeat; } }
    @media (max-width: 980px) { .nav { min-height: 110px; display: flex; justify-content: space-between; } .brand.has-logo { min-width: 0; max-width: min(620px, calc(100% - 190px)); } .brand-logo { max-width: min(620px, 100%); max-height: 82px; } .nav-links { display: none; } .template-hero-image-led .site-header { top: calc(14px + env(safe-area-inset-top)); left: 16px; right: 16px; border: 1px solid rgba(255, 255, 255, 0.14); border-radius: 18px; background: linear-gradient(180deg, rgba(5, 18, 32, 0.34), rgba(5, 18, 32, 0.16)); box-shadow: 0 16px 34px rgba(2, 6, 23, 0.2); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); overflow: hidden; } .template-hero-image-led .nav { min-height: 64px; display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 9px 11px; } .template-hero-image-led .brand, .template-hero-image-led .brand.has-logo { min-width: 0; max-width: calc(100% - 168px); display: flex; flex: 1 1 auto; align-items: center; overflow: hidden; } .template-hero-image-led .brand strong { max-width: 100%; font-size: 15px; line-height: 1.08; white-space: normal; overflow-wrap: anywhere; } .template-hero-image-led .brand span { display: none; } .template-hero-image-led .brand-logo { max-width: min(260px, 100%); max-height: 46px; object-fit: contain; } .template-hero-image-led .nav-call { position: static; min-height: 44px; max-width: min(34vw, 184px); flex: 0 0 auto; display: inline-flex; padding: 9px 14px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 13px; font-weight: 950; } .template-hero-image-led .visual-hero-content { justify-content: flex-start; } .template-hero-image-led .visual-hero-cta { justify-content: flex-start; } .template-hero-image-led .hero { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; aspect-ratio: auto; background: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-size: cover !important; } .quote-card, .areas-panel, .contact-layout { grid-template-columns: 1fr; } .services-grid, .trust-grid, .review-grid, .faq-grid, .footer-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); } }
    @media (max-width: 700px) { body { padding-bottom: 82px; } .container { width: min(100% - 28px, 1120px); } .nav { min-height: 88px; gap: 12px; } .brand.has-logo { min-width: 0; max-width: 100%; } .brand strong { max-width: 230px; font-size: 16px; line-height: 1.2; } .brand span { font-size: 12px; } .brand-logo { width: auto; height: auto; max-width: min(340px, 100%); max-height: 58px; object-fit: contain; } .nav-call { display: none; } .hero { min-height: auto; padding: 52px 0 82px; background-image: linear-gradient(90deg, rgba(2, 6, 23, 0.78), rgba(2, 6, 23, 0.48)), var(--hero-img-mobile); } .hero-content { max-width: 100%; } .template-hero-image-led .site-header { position: absolute; top: calc(10px + env(safe-area-inset-top)); left: 10px; right: 10px; z-index: 10000; border: 1px solid rgba(255, 255, 255, 0.14); border-radius: 16px; background: linear-gradient(180deg, rgba(5, 18, 32, 0.34), rgba(5, 18, 32, 0.16)); box-shadow: 0 14px 28px rgba(2, 6, 23, 0.18); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); pointer-events: auto; overflow: hidden; } .template-hero-image-led .nav { min-height: 54px; width: 100%; display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 8px 9px; } .template-hero-image-led .brand, .template-hero-image-led .brand.has-logo { min-width: 0; max-width: calc(100% - 138px); display: flex; flex: 1 1 auto; align-items: center; overflow: hidden; } .template-hero-image-led .brand strong { max-width: 100%; font-size: 13px; line-height: 1.08; white-space: normal; overflow-wrap: anywhere; } .template-hero-image-led .brand span, .template-hero-image-led .nav-links { display: none; } .template-hero-image-led .brand-logo { width: auto; height: auto; max-width: min(188px, 100%); max-height: 36px; object-fit: contain; } .template-hero-image-led .nav-call { position: static; min-height: 40px; max-width: min(42vw, 146px); flex: 0 0 auto; display: inline-flex; padding: 9px 12px; border: 1px solid rgba(255, 255, 255, 0.22); border-radius: 999px; background: var(--cta-color); color: var(--cta-text-color); box-shadow: 0 12px 24px rgba(2, 6, 23, 0.22); backdrop-filter: blur(4px); -webkit-backdrop-filter: blur(4px); font-size: 12px; font-weight: 950; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; pointer-events: auto; } .template-hero-image-led .hero { min-height: clamp(560px, 82vh, 720px); padding: 0 0 88px; align-items: flex-end; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.04) 0%, rgba(2, 6, 23, 0.1) 34%, rgba(2, 6, 23, 0.52) 100%), var(--hero-img-mobile); background-position: center center; background-size: cover; } .template-hero-image-led .visual-hero-content { max-width: 92%; margin: 0; } .template-hero-image-led .hero h1 { max-width: 100%; font-size: clamp(42px, 12.8vw, 62px); line-height: 0.92; letter-spacing: -0.056em; overflow-wrap: anywhere; } .template-hero-image-led .hero-subtitle { max-width: 28rem; margin-top: 13px; font-size: 15px; line-height: 1.46; } .template-hero-image-led .hero-label { margin-bottom: 8px; font-size: 10px; letter-spacing: 0.2em; } .template-hero-image-led .visual-hero-cta { width: auto; margin-top: 20px; justify-content: flex-start; } .template-hero-image-led .visual-hero-cta a { width: auto; min-width: min(100%, 190px); } .template-hero-image-led .hero .button { min-height: 50px; padding: 12px 16px; font-size: 14px; border-radius: 14px; } .template-hero-image-led .hero .button.accent { width: auto; box-shadow: 0 16px 34px rgba(2, 6, 23, 0.3), 0 0 24px rgba(20, 184, 166, 0.18); } h1 { max-width: 100%; font-size: clamp(44px, 14.2vw, 66px); line-height: 0.92; letter-spacing: -0.058em; overflow-wrap: anywhere; } .hero-subtitle { max-width: 30rem; margin-top: 14px; font-size: 16px; line-height: 1.48; } .hero-label { margin-bottom: 8px; font-size: 11px; letter-spacing: 0.2em; } .cta-row { margin-top: 21px; gap: 10px; } .button { min-height: 55px; font-size: 16px; } .hero-bullets { display: grid; grid-template-columns: 1fr 1fr; margin-top: 18px; } .hero-bullets span { border-radius: 12px; } .button, .cta-row, .cta-row a { width: 100%; } .template-hero-image-led .visual-hero-cta, .template-hero-image-led .visual-hero-cta a { width: auto; } .quote-strip { margin-top: -44px; } .template-hero-image-led .quote-strip { margin-top: 0; padding-top: 24px; } .quote-card, .contact-panel, .callback-form, .areas-panel { padding: 22px; } .mini-form, .services-grid, .trust-grid, .review-grid, .faq-grid, .footer-grid { grid-template-columns: 1fr; } .section { padding: 58px 0; } .footer { padding-bottom: 32px; } .footer-bottom { display: grid; } .mobile-call-bar { display: block; position: fixed; left: 12px; right: 12px; bottom: 12px; z-index: 80; } .mobile-call-bar a { min-height: 58px; display: flex; align-items: center; justify-content: center; border-radius: 12px; background: var(--cta-color); color: var(--cta-text-color); box-shadow: 0 18px 38px rgba(2, 6, 23, 0.24); font-size: 17px; font-weight: 950; text-decoration: none; } }
    @media (max-width: 700px) { .template-hero-image-led .nav-call { background: var(--cta-color); color: var(--cta-text-color); backdrop-filter: blur(4px); } .template-hero-image-led .hero { min-height: clamp(620px, 88vh, 780px); padding: 0; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile); background-position: center center; background-size: cover; } .template-hero-image-led .quote-strip { padding: 34px 0 30px; } .template-hero-image-led .quote-card { gap: 22px; padding: 24px; border-radius: 22px; } .template-hero-image-led .section { padding: 64px 0; } .template-hero-image-led h2 { font-size: clamp(31px, 10vw, 44px); line-height: 1; } .template-hero-image-led .section-header, .template-hero-image-led .section-header.center { margin-bottom: 24px; text-align: left; } .template-hero-image-led .trust-section .section-header.center, .template-hero-image-led .review-section .section-header { text-align: left; } .template-hero-image-led .service-card, .template-hero-image-led .trust-card, .template-hero-image-led .review-card, .template-hero-image-led .contact-panel, .template-hero-image-led .callback-form { padding: 24px; border-radius: 20px; } .template-hero-image-led .areas-panel { gap: 20px; padding: 24px; border-radius: 22px; } .template-hero-image-led .areas-list { justify-self: stretch; max-width: none; padding: 16px 18px; font-size: 16px; } .template-hero-image-led .map-wrap { margin-top: 22px; } .template-hero-image-led .map-panel h3 { padding: 14px 18px; } .template-hero-image-led .map-panel iframe { min-height: 300px; } .template-hero-image-led .faq-item summary { padding: 19px 20px; font-size: 17px; } .template-hero-image-led .faq-item p { padding: 0 20px 20px; } .template-hero-image-led .footer { padding-top: 46px; } .template-hero-image-led .footer h4 { margin-top: 8px; } }
    html[data-cb-preview-viewport="mobile"], html[data-cb-preview-viewport="tablet"] { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; width: 100%; max-width: 100%; overflow-x: hidden; scrollbar-width: none; }
    html[data-cb-preview-viewport="mobile"]::-webkit-scrollbar, html[data-cb-preview-viewport="tablet"]::-webkit-scrollbar, html[data-cb-preview-viewport="mobile"] body::-webkit-scrollbar, html[data-cb-preview-viewport="tablet"] body::-webkit-scrollbar { width: 0; height: 0; }
    html[data-cb-preview-viewport="mobile"] body, html[data-cb-preview-viewport="tablet"] body { width: 100%; max-width: 100%; overflow-x: hidden; scrollbar-width: none; }
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .site-header, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .site-header { position: absolute; top: calc(10px + env(safe-area-inset-top)); left: 10px; right: 10px; z-index: 10000; border: 1px solid rgba(255, 255, 255, 0.14); border-radius: 16px; background: linear-gradient(180deg, rgba(5, 18, 32, 0.34), rgba(5, 18, 32, 0.16)); box-shadow: 0 14px 28px rgba(2, 6, 23, 0.18); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); pointer-events: auto; overflow: hidden; }
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .nav, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .nav { min-height: 54px; width: 100%; display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 8px 9px; }
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .brand, html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .brand.has-logo, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand.has-logo { min-width: 0; max-width: calc(100% - 138px); display: flex; flex: 1 1 auto; align-items: center; overflow: hidden; }
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .brand-logo, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand-logo { width: auto; height: auto; max-width: min(188px, 100%); max-height: 36px; object-fit: contain; }
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .brand strong, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand strong { max-width: 100%; font-size: 13px; line-height: 1.08; white-space: normal; overflow-wrap: anywhere; }
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .brand span, html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .nav-links, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand span, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .nav-links { display: none; }
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .nav-call, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .nav-call { position: static; min-height: 40px; max-width: min(42vw, 146px); flex: 0 0 auto; display: inline-flex; padding: 9px 12px; border: 1px solid rgba(255, 255, 255, 0.22); border-radius: 999px; background: var(--cta-color); color: var(--cta-text-color); box-shadow: 0 12px 24px rgba(2, 6, 23, 0.22); backdrop-filter: blur(4px); -webkit-backdrop-filter: blur(4px); font-size: 12px; font-weight: 950; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; pointer-events: auto; }
    html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .site-header { top: calc(14px + env(safe-area-inset-top)); left: 16px; right: 16px; border-radius: 18px; }
    html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .nav { min-height: 64px; gap: 12px; padding: 9px 11px; }
    html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand.has-logo { max-width: calc(100% - 168px); }
    html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand-logo { max-width: min(260px, 100%); max-height: 46px; }
    html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .brand strong { font-size: 15px; }
    html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .nav-call { min-height: 44px; max-width: min(34vw, 184px); padding: 9px 14px; font-size: 13px; }
    html[data-cb-preview-viewport="mobile"] body.template-hero-image-led .hero, html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .hero { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; min-height: clamp(620px, 88vh, 780px); aspect-ratio: auto; padding: 0; background: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-color: #07111f; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-position: center center !important; background-repeat: no-repeat !important; background-size: cover !important; }
    html[data-cb-preview-viewport="tablet"] body.template-hero-image-led .hero { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; min-height: clamp(700px, 90vh, 900px); }
    ...
    @media (max-width: 700px) { .template-hero-image-led .site-header { top: calc(10px + env(safe-area-inset-top)); left: 10px; right: 10px; border-radius: 16px; } .template-hero-image-led .nav { min-height: 54px; gap: 8px; padding: 8px 9px; } .template-hero-image-led .brand, .template-hero-image-led .brand.has-logo { max-width: calc(100% - 138px); } .template-hero-image-led .brand-logo { max-width: min(188px, 100%); max-height: 36px; } .template-hero-image-led .brand strong { font-size: 13px; } .template-hero-image-led .nav-call { min-height: 40px; max-width: min(42vw, 146px); padding: 9px 12px; font-size: 12px; font-weight: 950; } .template-hero-image-led .hero { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; min-height: clamp(620px, 88vh, 780px); aspect-ratio: auto; padding: 0; background: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-color: #07111f; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-position: center center !important; background-repeat: no-repeat !important; background-size: cover !important; } .template-hero-image-led .hero::before, .template-hero-image-led .hero::after { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; background: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-color: #07111f; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-position: center center !important; background-repeat: no-repeat !important; background-size: cover !important; } .template-hero-image-led .quote-strip { margin-top: 0; } }
    @media (min-width: 701px) and (max-width: 980px) { .template-hero-image-led .site-header { top: calc(14px + env(safe-area-inset-top)); left: 16px; right: 16px; border-radius: 18px; } .template-hero-image-led .nav { min-height: 64px; gap: 12px; padding: 9px 11px; } .template-hero-image-led .brand, .template-hero-image-led .brand.has-logo { max-width: calc(100% - 168px); } .template-hero-image-led .brand-logo { max-width: min(260px, 100%); max-height: 46px; } .template-hero-image-led .brand strong { font-size: 15px; } .template-hero-image-led .nav-call { min-height: 44px; max-width: min(34vw, 184px); padding: 9px 14px; font-size: 13px; font-weight: 950; } .template-hero-image-led .hero { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; min-height: clamp(700px, 90vh, 900px); aspect-ratio: auto; padding: 0; background: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-color: #07111f; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-position: center center !important; background-repeat: no-repeat !important; background-size: cover !important; } .template-hero-image-led .hero::before, .template-hero-image-led .hero::after { --hero-img-desktop: var(--hero-img-mobile) !important; --hero-img: var(--hero-img-mobile) !important; background: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-color: #07111f; background-image: linear-gradient(180deg, rgba(2, 6, 23, 0.1) 0%, rgba(2, 6, 23, 0.02) 42%, rgba(2, 6, 23, 0.12) 100%), var(--hero-img-mobile) !important; background-position: center center !important; background-repeat: no-repeat !important; background-size: cover !important; } .template-hero-image-led .quote-strip { margin-top: 0; } }
  </style>
</head>
