...
${iconLinkHtml}
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .template-hero-image-led .site-header { position: relative; z-index: 10000; background: rgba(2, 6, 23, 0.12); border-bottom: 0; box-shadow: none; backdrop-filter: blur(3px); pointer-events: auto; }
