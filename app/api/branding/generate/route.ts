...
function buildPrompt(args: {
  ...
  if (args.mode === "mobile-hero") {
    return [
      ...
      "Focus the artwork on the business logo, one short stacked headline, a branded vehicle and a cinematic local trade scene.",
      "Do not include trust icon rows, badge rows or repeated proof icons.",
      "Do not bake CTA buttons into the artwork.",
      "Keep the lower-middle and lower-center area clean for the website call-to-action overlay.",
      "Avoid placing vehicle branding directly behind the expected lower CTA placement.",
      "Leave safe space for the small top phone pill and keep important text away from extreme left/right edges.",
      "Keep vehicle or business branding visible where suitable, preferably above or beside the lower CTA zone.",
